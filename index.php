...
<header class="header">
    ...
    <a href="#" class="logo"> <i class="fas fa-heartbeat"></i> <strong>BHARAT</strong>medical </a>
...
<section class="review" id="review">
    ...
    <div class="box-container">
        ...
        <div class="box">
            <img src="image/Abhishek.png" alt="">
            <h3>Ranjanabhi7</h3>
            <div class="stars">
...
<section class="footer">
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <a href="#"> <i class="fas fa-phone"></i> +918002892991 </a>
            <a href="#"> <i class="fas fa-phone"></i> +918002892991 </a>
            <a href="#"> <i class="fas fa-envelope"></i> 07abhirishi7@gmail.com </a>
            <a href="#"> <i class="fas fa-envelope"></i> abhishek.ranjan7602@gmail.com </a>
            <a href="#"> <i class="fas fa-map-marker-alt"></i> bihar, india </a>
        </div>
    ...
    <div class="credit"> created by <span>Ranjanabhi7</span> | all rights reserved </div>
